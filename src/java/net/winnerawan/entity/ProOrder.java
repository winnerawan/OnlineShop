...
public class ProOrder  implements java.io.Serializable {
    ...
    public ProOrder(DeliveryCost deliveryCost, ShopUser shopUser, int proId, Date orderDate, int orderQty, double totalPrice, String orderStatus) {
    ...
    public ProOrder(DeliveryCost deliveryCost, ShopUser shopUser, int proId, Date orderDate, int orderQty, double totalPrice, String orderStatus, Set proOrderDetailses) {
       this.deliveryCost = deliveryCost;
       this.shopUser = shopUser;
       this.proId = proId;
       this.orderDate = orderDate;
